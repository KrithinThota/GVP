...
export default async function Home({ params }: { params: { id: string } }) {
  ...
  const permission = await getPermission("view:student");
      ...
      <div className="flex-grow h-full overflow-y-auto items-center justify-center py-2 ">
        <div className="container mx-auto py-10 px-5">
          ...
          <p className="mb-4">
            ...
            established under the parent society ‘Gayatri Vidya Parishad’ (GVP),
            a non-profitable organization comprising of noted educationists and
            eminent philanthropists who have a missionary zeal to provide
            quality technical education. From that point on, the college has
            very quickly established itself as one of the most-preferred
            self-financing engineering colleges in Andhra Pradesh offering 10
            B.Tech. Programs, 5 M.Tech. and one MCA Program approved by AICTE
            with an intake of 1260.
          </p>
          ...
          <h3 className="text-xl font-semibold mt-8">Post-Graduate Programs</h3>
          <table className="min-w-full bg-white border border-gray-300 mt-4">
            <thead>
              <tr>
          ...
          <p className="mb-4">
            Sprawl over an area of 21 acres with a total built-up area of 44,000
            m², the college offers a serene and eco-friendly learning
            environment. Specialized labs, collaborations with industries, and a
            well-equipped library enhance the student learning experience.
          </p>
